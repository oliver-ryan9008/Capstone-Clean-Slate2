...
Scheduler.plugin(function (e) {
    !function () {
        function t(t) { var a = e._get_section_view(); a && t && (i = e.getEvent(t)[e._get_section_property()]) } var i, a; e.config.collision_limit = 1, e.attachEvent("onBeforeDrag", function (e) { return t(e), !0 }), e.attachEvent("onBeforeLightbox", function (i) { var n = e.getEvent(i); return a = [n.start_date, n.end_date], t(i), !0 }), e.attachEvent("onEventChanged", function (t) {
            ...
            var a = e._get_section_property(); return t[a] == i[a] && t.id != i.id ? !0 : !1
        }, e.checkCollision = function (t) {
            var a = [], n = e.config.collision_limit; if (t.rec_type) for (var r = e.getRecDates(t), s = 0; s < r.length; s++)for (var d = e.getEvents(r[s].start_date, r[s].end_date), o = 0; o < d.length; o++)(d[o].event_pid || d[o].id) != t.id && a.push(d[o]); else { a = e.getEvents(t.start_date, t.end_date); for (var l = 0; l < a.length; l++)if (a[l].id == t.id) { a.splice(l, 1); break } } var _ = e._get_section_view(), h = e._get_section_property(), c = !0; if (_) {
                for (var u = 0, l = 0; l < a.length; l++)a[l].id != t.id && this._check_sections_collision(a[l], t) && u++;
                u >= n && (c = !1)
            } else a.length >= n && (c = !1); if (!c) { var g = !e.callEvent("onEventCollision", [t, a]); return g || (t[h] = i || t[h]), g } return c
        }
    }()
});